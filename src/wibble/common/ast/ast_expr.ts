...
export class PStructField extends PExpr {
  constructor(public name: Token | undefined, public gap: Token[], public value: PExpr) {
...
export class PIf extends PExpr {
  constructor(
    ...
    super(
      PExprKind.IF, "if",
      [ ifToken, space1, condition, space2, thenToken, space3, onTrue, space4, elseToken, space5, onFalse ]
    );
  }
}
