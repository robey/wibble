...
describe("Parse code", () => {
  describe("code", () => {
    ...
    it("assignment", () => {
      ...
      p2.toCode().should.eql("count := count + 1");
    });
    ...
    describe("let", () => {
      ...
      it("compound", () => {
        ...
        p1.toCode().should.eql("let x = 5, var y = 10, z = 3");
        ...
        p2.toCode().should.eql("let var a = 1,\nb = 3");
      });
    });
    ...
    it("handler", () => {
      ...
      p3.toCode().should.eql("on (x: Int) -> x * 2");
      ...
      p4.toCode().should.eql("on .inspect: String -> false");
