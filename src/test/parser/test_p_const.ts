...
describe("Parse constants", () => {
  ...
  it("symbol", () => {
    ...
    parse(".hello").toCode().should.eql(".hello");
  });
  ...
  it("base 16", () => {
    ...
    parse("0x2f").toCode().should.eql("0x2f");
  });
  ...
  it("base 2", () => {
    ...
    parse("0b11").toCode().should.eql("0b11");
  });
  ...
  describe("string", () => {
    ...
    it("with quotes", () => {
      ...
      parse("\"quote \\\" ha\"").toCode().should.eql("\"quote \\\" ha\"");
    });
    ...
    it("with escapes", () => {
      ...
      parse("\"what\\u{21}?\"").toCode().should.eql("\"what\\u{21}?\"");
    });
  });
